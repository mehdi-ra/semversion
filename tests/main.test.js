...
// Mock @octokit/rest
jest.mock('@octokit/rest', function () { return ({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    core.getInput.mockImplementation(function (name) {
                        var inputs = {
                            repo_name: 'test/repo',
                            token: 'test-token',
                            branch_name: 'main',
                    ...
                    return [4 /*yield*/, expect((0, main_1.run)()).resolves.not.toThrow()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should handle errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    core = require('@actions/core');
                    core.getInput.mockImplementation(function () {
