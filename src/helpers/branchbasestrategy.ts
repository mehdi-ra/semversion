import {
  isBranchCandidateForMajorIncreaseRegEx,
  isBranchCandidateForMinorIncreaseRegEx,
  isBranchCandidateForPatchIncreaseRegEx,
} from '../const';
 ...
 * @param commitMessage
 */
export function detectBranchBaseVersionChange(
  target: string,
  source: string,
  releaseBranch: string = 'develop'
): TVersionChange {
  try {
